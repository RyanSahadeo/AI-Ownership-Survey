...
// Condition descriptions for display on survey page
const CONDITION_DESCRIPTIONS = {
  1: "In this organization, employees are required to follow strict procedures and standardized rules when completing their tasks. There is little flexibility, and individual input does not influence how work is carried out.",
  2: "In this organization, employees regularly adjust how they approach their work based on experience and feedback. Over time, individuals develop more effective ways of working that shape how tasks are performed.",
  3: "In this organization, decisions are always accompanied by clear explanations of how and why they were made. Employees are expected to understand the reasoning behind outcomes and how different factors influence results.",
  4: "In this organization, employees are encouraged to develop original ideas and create new approaches as part of their work. Individual creativity and personal input play a central role in shaping outcomes.",
  5: "In this organization, employees develop initial work that is then reviewed and modified by supervisors before final decisions are made. Final outcomes reflect a combination of employee input and supervisory judgment."
};
